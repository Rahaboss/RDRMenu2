...
namespace Menu
{
	...
	void RenderDebugButtons()
	{
		...
		if (ImGui::Button("Activate Grand Korrigan Interiors"))
		{
			QUEUE_JOB(=)
			{
				//INTERIOR::ACTIVATE_INTERIOR_ENTITY_SET(INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPEHASH(2552.205f, -1170.773f, 52.6838f, RAGE_JOAAT("NEW_TAILOR01_INT_MAIN")), 0);
				//INTERIOR::ACTIVATE_INTERIOR_ENTITY_SET(INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPEHASH(2552.205f, -1170.773f, 52.6838f, RAGE_JOAAT("NEW_TAILOR01_INT_MAIN")), 0);
				//INTERIOR::ACTIVATE_INTERIOR_ENTITY_SET(INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPEHASH(2654.253f, -1179.118f, 52.2785f, RAGE_JOAAT("NEW_BARBER_INT")), 0);
				//INTERIOR::ACTIVATE_INTERIOR_ENTITY_SET(INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPEHASH(2654.533f, -1178.978f, 52.2785f, RAGE_JOAAT("NEW_BARBER_INT")), 0);
				//INTERIOR::ACTIVATE_INTERIOR_ENTITY_SET(INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPEHASH(3286.869f, -1304.827f, 50.7904f, RAGE_JOAAT("SER_GRANDKOR_L2_INT")), 0);
				//INTERIOR::ACTIVATE_INTERIOR_ENTITY_SET(INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPEHASH(3288.151f, -1300.511f, 50.9101f, RAGE_JOAAT("SER_GRANDKOR_L2_INT")), 0);
				INTERIOR::ACTIVATE_INTERIOR_ENTITY_SET(INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPEHASH(3288.815f, -1309.385f, 41.7978f, RAGE_JOAAT("SER_GRANDKOR_L1_INT")), "korrigan_props_poker", 0);
				INTERIOR::ACTIVATE_INTERIOR_ENTITY_SET(INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPEHASH(3289.768f, -1309.406f, 41.792f, RAGE_JOAAT("SER_GRANDKOR_L1_INT")), "korrigan_props_default", 0);
			}
			END_JOB()
		}
		ImGui::SameLine();
